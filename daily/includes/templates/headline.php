...
<span class="single-cat-feedlink cat-feedlink"><a href="<?php echo get_category_feed_link($cat, ''); ?>" title="<?php printf(__('Subscribe RSS feed of %s','themejunkie'),get_cat_name($cat)); ?>"><?php printf(__('Subscribe RSS feed of category %s','themejunkie'), get_cat_name($cat)); ?></a></span>
