	...
	array( "name" => "nav-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Favicon",
			 ...
			 array( "name" => "Show share buttons on homepage and archives",
                   "id" => $shortname."_enable_share_buttons",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "desc. "),		
		...
		array( "name" => "general-1",
			   ...
			   "type" => "subcontent-start",),				 				
				 ...
				 array( "name" => "Show social profiles on the header",
                   "id" => $shortname."_show_social_profiles",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "desc. "),		
			...
			array( "name" => "Your Facebook Page ID",
				   "id" => $shortname."_facebook_page_id",
				   "type" => "text",
				   "std" => "yourpageurl",
				   "desc" => "desc",),				   			
				   
			array( "name" => "Your Newsletter ID",
				   "id" => $shortname."_newsletter_id",
				   "type" => "text",
				   "std" => "ThemeJunkie",
				   "desc" => "desc",),

			array( "name" => "Your Custom RSS ID",
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "nav-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Number of excerpt characters to show",
                   "id" => $shortname."_excerpt_char_num",
                   "type" => "text",
                   "std" => "180",
				   "desc" => "desc."),
				   
			array( "name" => "Enable Featured Content",
			...
			array( "name" => "Number of featured posts to show",
                   "id" => $shortname."_featured_post_num",
                   "type" => "text",
                   "std" => "5",
				   "desc" => "desc."),
					 
			array( "name" => "Enable Content Bar",
                   "id" => $shortname."_content_bar_enable",
                   "type" => "checkbox",
                   "std" => "on",
				   "desc" => "Enable this option will remove the Content Bar from homepage."),
		...
		array( "name" => "layout-2",
		  ...
		  array( "name" => "Show Newsletter on posts",
                   "id" => $shortname."_show_newsletter_form",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "desc. "),
									 
		  array( "name" => "Show share buttons on posts",
                   "id" => $shortname."_show_share_buttons",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "desc. "),		

			array( "name" => "Show related articles on posts",
