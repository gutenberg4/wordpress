...
/**
 * Sanitization for on-off radio
 */
function of_sanitize_onoff( $input ) {
	$output = '';
	$output = $input;
	return $output;
}
add_filter( 'of_sanitize_onoff', 'of_sanitize_onoff' );
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'freshlife' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'freshlife' ),
		'repeat-y'  => __( 'Repeat Vertically', 'freshlife' ),
		'repeat'    => __( 'Repeat All', 'freshlife' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'freshlife' ),
		'top center'    => __( 'Top Center', 'freshlife' ),
		'top right'     => __( 'Top Right', 'freshlife' ),
		'center left'   => __( 'Middle Left', 'freshlife' ),
		'center center' => __( 'Middle Center', 'freshlife' ),
		'center right'  => __( 'Middle Right', 'freshlife' ),
		'bottom left'   => __( 'Bottom Left', 'freshlife' ),
		'bottom center' => __( 'Bottom Center', 'freshlife' ),
		'bottom right'  => __( 'Bottom Right', 'freshlife')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'freshlife' ),
		'fixed'  => __( 'Fixed in Place', 'freshlife')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'freshlife' ),
		'italic'      => __( 'Italic', 'freshlife' ),
		'bold'        => __( 'Bold', 'freshlife' ),
		'bold italic' => __( 'Bold Italic', 'freshlife' )
		);
