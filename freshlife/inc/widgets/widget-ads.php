 ...
 * @since      1.0.0
 */
class Freshlife_Ads_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-freshlife-ad widget_ads',
			'description' => __( 'Easily to display any type of ad.', 'freshlife' )
		);

		// Create the widget.
		parent::__construct(
			'freshlife-ads',                            // $this->id_base
			__( '&raquo; Advertisement', 'freshlife' ), // $this->name
