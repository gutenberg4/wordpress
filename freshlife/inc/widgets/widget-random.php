 ...
 * @since      1.0.0
 */
class Freshlife_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-freshlife-random posts-thumbnail-widget',
			'description' => __( 'Display random posts with thumbnails.', 'freshlife' )
		);

		// Create the widget.
		parent::__construct(
			'freshlife-random',                                   // $this->id_base
			__( '&raquo; Random Posts Thumbnails', 'freshlife' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'freshlife' ),
			'limit'     => 5,
			'show_date' => false
		);
