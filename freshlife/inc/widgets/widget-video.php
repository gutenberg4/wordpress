 ...
 * @since      1.0.0
 */
class Freshlife_Video_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-freshlife-video video-widget',
			'description' => __( 'Easily to display any type of video.', 'freshlife' )
		);

		// Create the widget.
		parent::__construct(
			'freshlife-video',                  // $this->id_base
			__( '&raquo; Video', 'freshlife' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Video', 'freshlife' ),
			'video_url'  => '',
			'video_code' => ''
		);
